...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="list-group list-group-flush my-3">
          ...
          <a href="calendario.html" class="list-group-item list-group-item-action bg-transparent second-text active"><i 
        ...
        <div class="container">
          ...
          <div class="registration-form">
            <form>
                ...
                <input type="hidden" name="cod_cliente" value="<?php echo $cod_paciente?>">
                <div class="form-icon">
                ...
                <div class="form-group">
                    <input type="text" class="form-control item" name="nome" placeholder="Nome Completo" <?php echo $paciente['nome']?>>
                </div>
                <div class="form-group">
                    <input type="password" class="form-control item" name="cpf" placeholder="CPF" <?php echo $paciente['cpf']?>>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control item" name="telefone" placeholder="Telefone" <?php echo $paciente['telefone']?>>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control item" name="data_nasc" placeholder="Data de Nascimento" <?php echo $paciente['data_nasc']?>>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control item" name="email" placeholder="Email" <?php echo $paciente['email']?>>
                </div>

                <div class="form-group">
                    <input type="text" class="form-control item" name="senha" placeholder="Senha" <?php echo $paciente['senha']?>>
                </div>
                <div class="form-group">
                    <button type="button" class="btn btn-block create-account">Enviar</button>
                </div>
            </form>
